        ...
        <div>
            ...
            >
                <Box sx={style}>
                    ...
                    {(!value || value===2) && (<Box sx={{ height: '55px', background: '#EDE4FE80 0% 0% no-repeat padding-box', borderRadius: '6px', p: '10px',alignContent: 'center', ml:'22px', mr:'22px', cursor: 'pointer'}} onClick={()=> setValue(2)}>
                        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    ...
                    {(!value || value===3) && (<Box sx={{ height: '55px', background: '#DBF0F180 0% 0% no-repeat padding-box', borderRadius: '6px', p: '10px',alignContent: 'center', ml:'22px', mr:'22px', cursor: 'pointer'}} onClick={()=> setValue(3)}>
                        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    ...
                    {(!value || value===4) && (<Box sx={{ height: '55px', background: '#E4EDFF80 0% 0% no-repeat padding-box', borderRadius: '6px', p: '10px',alignContent: 'center',  ml:'22px', mr:'22px', cursor: 'pointer'}} onClick={()=> setValue(4)}>
                        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    ...
                    {(!value || value===5) && (<Box sx={{ height: '55px', background: '#FFFAD880 0% 0% no-repeat padding-box', borderRadius: '6px', p: '10px',alignContent: 'center',ml:'22px', mr:'22px', cursor: 'pointer'}} onClick={()=> setValue(5)}>
                        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    ...
                    {(!value || value===6) && (<Box sx={{ height: '55px', background: '#FEEAEA80 0% 0% no-repeat padding-box', borderRadius: '6px', p: '10px',alignContent: 'center',ml:'22px', mr:'22px', mb:'22px', cursor: 'pointer'}} onClick={()=> setValue(6)}>
                        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
